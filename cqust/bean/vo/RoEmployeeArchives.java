 ...
 * @desc: /employeeArchives
 **/
@SuppressWarnings("unused")
public class RoEmployeeArchives {
    private Integer employeeArchivesId;
    ...
    public void setEmployeeArchivesId(Integer employeeArchivesId) {
        this.employeeArchivesId = employeeArchivesId;
    }
    ...
    public String getGinsengTime() {
        return ginsengTime;
    }

    public void setGinsengTime(String ginsengTime) {
        this.ginsengTime = ginsengTime;
    }
