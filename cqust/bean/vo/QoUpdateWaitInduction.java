...
public class QoUpdateWaitInduction {
    ...
    //wait_induction_info
    private Integer waitInductionInfoId;
    ...
    public Integer getWaitInductionInfoId() {
        return waitInductionInfoId;
    }

    public void setWaitInductionInfoId(Integer waitInductionInfoId) {
        this.waitInductionInfoId = waitInductionInfoId;
    }
